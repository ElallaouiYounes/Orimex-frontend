...
import { FaSearch, FaFilter, FaSort, FaFileInvoiceDollar } from "react-icons/fa";

const ModernTransactionsHeader = () => {
  return (
    <div className="w-full shadow-sm py-6">
      {/* Top section with title and create button */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 mb-1">Transactions Management</h1>
          <p className="text-gray-500 text-sm">View and manage all financial transactions</p>
        </div>
...
export default ModernTransactionsHeader;