...
import { FaSearch, FaFilter, FaSort, FaUserPlus } from "react-icons/fa";

const ModernCustomersHeader = () => {
  return (
    <div className="w-full shadow-sm py-6">
      {/* Top section with title and create button */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 mb-1">Customers Management</h1>
          <p className="text-gray-500 text-sm">Manage your glass product customers and their information</p>
        </div>
...
export default ModernCustomersHeader;