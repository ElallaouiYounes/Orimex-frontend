...
import { FaSearch, FaFilter, FaSort, FaPlus, FaRoute } from "react-icons/fa";

const ModernDeliveriesHeader = () => {
  return (
    <div className="w-full shadow-sm py-6">
      {/* Top section with title and create button */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 mb-1">Delivery Tracking</h1>
          <p className="text-gray-500 text-sm">Monitor and manage all product deliveries</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        <div className="relative md:col-span-4">
          ...
          <input
            ...
            placeholder="Search by delivery ID, order, customer..."
          />
        </div>
        ...
        <div className="relative md:col-span-3">
          <select className="block w-full pl-3 pr-10 py-2.5 text-gray-700 border border-gray-200 sm:text-sm rounded-lg bg-gray-50 appearance-none focus:outline-none focus:border-2 focus:border-blue-600">
            ...
            <option value="Mohammed Amrani">Mohammed Amrani</option>
            <option value="Hassan El Mansouri">Hassan El Mansouri</option>
            <option value="Karim Belhaj">Karim Belhaj</option>
            <option value="Youssef Bennis">Youssef Bennis</option>
          </select>
          <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-400">
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
        ...
        <div className="relative md:col-span-2">
          <button className="flex w-full justify-center items-center px-4 py-2.5 border border-gray-200 rounded-lg bg-gray-50 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:border-2 focus:border-blue-600">
            <FaRoute className="mr-2 text-gray-500" />
            View Routes
          </button>
        </div>
      </div>
...
export default ModernDeliveriesHeader;